...
public class DeportivoHibrido extends Hibrido {
    ...
    private String tipoTransmision; // Tipo de transmisión (manual, automática, secuencial)
    ...
    // Constructor
    public DeportivoHibrido(double capacidadTanque, double capacidadBateria, double autonomiaTotal, double autonomiaElectrica,
                            String tipoHibrido, double rendimientoCombinado, String placa, String marca, String modelo,
                            double precio, double velocidadMaxima, double aceleracion, String tipoTransmision) {
    ...
    public void mostrarCaracteristicas() {
        System.out.println("=================================");
        System.out.println("   Características del Deportivo Híbrido");
        System.out.println("=================================");
    ...
    public void realizarInspeccion() {
        if (!inspeccionRealizada) {
            ...
            System.out.println("Inspección realizada para el Deportivo Híbrido con placa " + getPlaca());
        } else {
            System.out.println("El Deportivo Híbrido con placa " + getPlaca() + " ya tiene una inspección realizada.");
        }
    }
