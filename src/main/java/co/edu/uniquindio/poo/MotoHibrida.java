...
public class MotoHibrida extends Hibrido {
    ...
    // Constructor
    public MotoHibrida(double capacidadTanque, double capacidadBateria, double autonomiaTotal, double autonomiaElectrica,
    ...
    public void mostrarCaracteristicas() {
        System.out.println("=================================");
        System.out.println("Características de la Moto Híbrida");
        System.out.println("=================================");
    ...
    public void realizarInspeccion() {
        if (!inspeccionRealizada) {
            ...
            System.out.println("Inspección realizada para la Moto Híbrida con placa " + getPlaca());
        } else {
            System.out.println("La Moto Híbrida con placa " + getPlaca() + " ya tiene una inspección realizada.");
        }
    }
